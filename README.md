...
* **Độ ẩm môi trường:** `farm/ha/sensor/water_quality_ph_w218_do_am/state`
* **Độ chống oxy hóa (ORP):** `farm/ha/sensor/water_quality_ph_w218_oxidation_reduction_potential/state`
* **Độ mặn:** `farm/ha/sensor/water_quality_ph_w218_salinity/state`
* **Hệ số dẫn điện (CF):** `farm/ha/sensor/water_quality_ph_w218_conductivity_factor/state`
* **Tỷ trọng / Trọng lượng riêng (SG):** `farm/ha/sensor/water_quality_ph_w218_specific_gravity/state`
